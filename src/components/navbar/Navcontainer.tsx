...
const Navcontainer:React.FC<Props> = ({
    ...
    return (
        <div className='navcontainer'>
            ...
            <List classname={listprops.classname} classnameli={listprops.classnameli} content={listprops.contentlist}></List>
            </div>
            <div className={`nav-buttons ${!listprops.toggleView ? '' : 'active-buttons'}`}>
            <Button className={buttonprops1.classname} type={buttonprops1.buttontype} value={buttonprops1.value}>
                Signup
            </Button>
            <Button className={buttonprops2.classname} type={buttonprops2.buttontype} value={buttonprops2.value}>
                User Login
            </Button>
            </div>
        </div>
