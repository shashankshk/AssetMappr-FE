        ...
        <Background classname='App' backgroundImage={imageUrl}>
            <Card classname='card'>
                ...
                <div className="profile_container">
                    <InputLabel htmlfor='date_of_birth' classname='required_dob' content='1. What is your date of birth?'/>
                    <InputField type="date" id="date_of_birth" className="profile_dateofbirth" placeholder="MM/DD/YYYY" autocomplete="off" required={true}/>
                    
                    <InputLabel htmlfor='ethnicity' content='2. What is your ethnicity? (Optional)'/>
                    <SelectOption classname='select_ethnicity' id='ethnicity' name='ethnicity' initialValue='' initialLabel='Select your response' options={ethnicityOptions}></SelectOption>

                    <InputLabel htmlfor='race' content='3. What is your race? (Optional)'/>
                    <SelectOption classname='select_race' id='race' name='race' onchange={(e) => setSelectedRace(e.target.value)} initialValue='' initialLabel='Select your response' options={raceOptions}></SelectOption>
                    
                    {selectedRace==='self_identify' && <InputField type="text" className="self_race" placeholder="Please tell us what you identify as (optional)"/>}

                    <InputLabel htmlfor='sex' content='4. What is your sex? (Optional)'/>
                    <SelectOption classname='select_sex' id='sex' name='sex' onchange={(e) => setSelectedSex(e.target.value)} initialValue='' initialLabel='Select your response' options={selectedSexOptions}/>

                    {selectedSex==='Other' && <InputField type="text" className="self_sex" placeholder="Please tell us which (optional)"/>}

                    </div>
                    <Button type="submit" value="Finish" className="profile_continue_button">Finish</Button>
                    </form>
                </Card>
        </Background>
    )
