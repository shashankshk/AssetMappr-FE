...
const DisclaimerScreen = () => {
    ...
    const items = [
        ...
        { key: 5, data: 'Planners and app developers do NOT have access to individual user information or profiles.' },
        { key: 6, data: 'You are the sole owner of your data.' },
        { key: 7, data: 'By participating, you are making a valuable contribution to your community. Thank you for your trust and support!' },
    ];
    useEffect(() => {
    ...
    <Background classname='App' backgroundImage={imageUrl}>
        <Card classname='card'>
            ...
            <Button type="submit" value="Continue" className="accept_button" onClick={next}>Continue</Button>
        </Card>
    </Background>
    )
}
